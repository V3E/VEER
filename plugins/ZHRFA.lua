...
if VEERBOT:get(VEER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
VEERBOT:del(VEER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
if utf8.len(text) > 20 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ لا يمكن زخرفة اكثر من 20 حرف *', 1, 'md') 
VEERBOT:del(VEER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, SEND_SKRF,  1, "md")
VEERBOT:del(VEER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
end
end
end
...
if VEERBOT:get(VEER_ID..'lock:skrfa'..msg.chat_id_)  then
mohmad = '*📮¦ تم تفعيل الزخرفه *\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, mohmad, 1, "md") 
VEERBOT:del(VEER_ID..'lock:skrfa'..msg.chat_id_) 
else
mohmad = '*📮¦ بالتاكيد تم تفعيل الزخرفه  *\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, mohmad, 1, "md") 
end
return false
end
if MSG_TEXT[1] == 'تعطيل الزخرفه' and is_mod(msg) then   
if not VEERBOT:get(VEER_ID..'lock:skrfa'..msg.chat_id_)  then
mohmad = '*📮¦ تم تعطيل الزخرفه *\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, mohmad, 1, "md") 
VEERBOT:set(VEER_ID..'lock:skrfa'..msg.chat_id_,true) 
else
mohmad = '*📮¦ بالتاكيد تم تعطيل الزخرفه  *\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, mohmad, 1, "md") 
end
return false
end
...
if not VEERBOT:get(VEER_ID.."lock:skrfa"..msg.chat_id_) then   
VEERBOT:setex(VEER_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
local t = '*⚡¦* ارسل الاسم الذي تريد زخرفته \n*📬¦* سواء كان بالعربي او بالانكلش 🍁'   
VEER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
else
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ الزخرفه معطله *', 1, 'md') 
end
return false
end
